...
public class DateColumnDecorator implements DisplaytagColumnDecorator, DateProviderAware
{
	...
	public DateColumnDecorator()
	{
		...
		dateFormat = new SimpleDateFormat(dateProvider.getDateFormat() + " h:mm a");
	}	
