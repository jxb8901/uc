...
import net.ninecube.reports.providers.AlertProviderAware;
import net.ninecube.reports.providers.DateProvider;
import net.ninecube.reports.providers.DateProviderAware;
import net.ninecube.reports.providers.SchedulerProvider;
import net.ninecube.reports.providers.SchedulerProviderAware;
import net.ninecube.reports.providers.UserProvider;
import net.ninecube.reports.providers.UserProviderAware;
...
public class ReportScheduleAction extends ActionSupport implements SchedulerProviderAware, DateProviderAware, AlertProviderAware, UserProviderAware
{
	...
	public String execute()
	{
		...
		{
			addActionError(LocalStrings.getString(LocalStrings.ERROR_DATEANDTIME_INVALID));
			return INPUT;
		}
		...
		{			
			...
			else
			{
				...
				Map reportParameters = (Map) ActionContext.getContext().getSession().get(
	...
	{
		return dateProvider.getDateFormat();
	}
