...
import net.ninecube.reports.providers.persistence.ReportPersistenceProvider;
...
public class ReportProviderImpl
	implements ReportProvider, DirectoryProviderAware
{
	protected static Logger log =
		Logger.getLogger(ReportProviderImpl.class.getName());
