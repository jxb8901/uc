...
public class DataSourcePersistenceProvider 
{
	...
	{
		String fromClause =
			"from net.ninecube.reports.objects.ReportDataSource reportDataSource order by reportDataSource.name ";
		...
		throws ProviderException
	{
		...
		{
			throw new ProviderException(LocalStrings.getString(LocalStrings.ERROR_DATASOURCE_DELETION), ce);
		}
	}
}
