...
public class ParameterPersistenceProvider 
{
		...
		try
		{
			...
			try
			{
				List list = session.createQuery(
						"from net.ninecube.reports.objects.ReportParameter reportParameter "
	...
	{
		String fromClause =
			"from net.ninecube.reports.objects.ReportParameter reportParameter order by reportParameter.name ";
		...
		throws ProviderException
	{
		...
		{
			throw new ProviderException(LocalStrings.getString(LocalStrings.ERROR_PARAMETER_DELETION), ce);
		}
	}
}
