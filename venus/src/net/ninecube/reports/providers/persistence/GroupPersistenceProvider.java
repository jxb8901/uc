...
public class GroupPersistenceProvider 
{
	...
	{
		String fromClause =
			"from net.ninecube.reports.objects.ReportGroup reportGroup order by reportGroup.name ";
		...
		try
		{
			...
			{			
				List list = session.createQuery(
						"from net.ninecube.reports.objects.ReportGroup as reportGroup "
		...
		throws ProviderException
	{
		...
		{
			throw new ProviderException(LocalStrings.getString(LocalStrings.ERROR_GROUP_DELETION), ce);
		}
	}
}
