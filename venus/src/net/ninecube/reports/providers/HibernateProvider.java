...
import net.ninecube.reports.providers.persistence.ConstraintException;
...
//		log.info("SessionFactory Created.");
	...
	public static Object save(Object object) throws ProviderException
	{
		...
		catch (HibernateException he)
		{
			...
			{
				throw new ProviderException(LocalStrings.getString(LocalStrings.ERROR_UNIQUE_CONSTRAINT), he);
			}
